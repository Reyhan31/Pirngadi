...
@section('content')
    <!-- HERO -->
    <div class="hero h-auto d-flex justify-content-center " id="managedesktop">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 pt-5">
              <div class="">
              <h1 class="display-4 text-white">Desktop Management Services</h1>
              <ul class="list-unstyled">
                <li><i class="bx bxs-check-circle"></i> End to end management</li>
                <li><i class="bx bxs-check-circle"></i> Enabling stable & secured environment</li>
                <li><i class="bx bxs-check-circle"></i> Operates efficiency & cost effectively</li>
              </ul>
              </div>
          </div>
  ...
  <div class="d-flex justify-content-evenly row">
      ...
      <div class="col-sm-3">
          <div class="upper mb-5">
              <img src="img/DesktopManagementService.jpg" alt="" >
          </div>
        <h5 class="text-center mb-3">Four keys focus area</h5>
        <p class="text-center">Our desktop management services offering focuses on four key areas: Hardware liaise, Deployment new unit, Operational( Preventive Maintenance, Corrective Maintenance, Asset Management, Detail Reporting), Unit Extraction/ Dismantle.</p>
